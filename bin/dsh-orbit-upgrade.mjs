...
optional: DSH_ORBIT_VERSION, DSH_SMOKE_ORIGIN, DSH_SMOKE_CONNECTION_PATCH (must
match the generation reviewed for DSH_VERSION when set; the runner derives the
generation from the candidate's compatibility profile), DSH_UPGRADE_PROJECT,
DSH_UPGRADE_COMPOSE,
